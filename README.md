## 2022-03-10更新： 只有我一个人用，实例去年10月份就已经释放 secretkey id 和 secret 泄露，被人利用开了台最贵的机器，原来账号里面的money被耗光，还欠费几百大洋，原来的阿里云账号已经用不了了
# circle的前端小程序(头条小程序)
...
　　所以，这个小程序前端，就有了两个版本，v1版本首页像朋友圈，但是个人详情页又有关注的人、收藏的文章，[**所以v1版本的产品定位出现了问题，做成了个四不像**](#none)，首页像朋友圈，个人详情页又只有微博、头条这类产品才有，然后就变成了v2。
